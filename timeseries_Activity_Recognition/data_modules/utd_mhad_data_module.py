...
class UTDDataset(MMHarDataset):
    ...
    def _supported_modalities() -> List[str]:
        return ["inertial", "skeleton", "emg", "insole", "bio", "gaze"]
...
class UTDDataModule(MMHarDataModule):
    ...
    def __init__(self, 
            ...
            modalities: List[str] = ["inertial", "skeleton", "emg", "insole", "bio", "gaze"],
            batch_size: int = 32,
...
if __name__ == '__main__':
    train_transforms = {
        ...
        "emg": transforms.Compose([ToTensor(), ToFloat(), Jittering(0.05), InertialSampler(150)]),      
        "insole": transforms.Compose([ToTensor(), ToFloat(), Jittering(0.05), InertialSampler(150)]),
        "bio": transforms.Compose([ToTensor(), ToFloat(), Jittering(0.05), InertialSampler(150)]),
        "gaze": transforms.Compose([ToTensor(), ToFloat(), Jittering(0.05), InertialSampler(150)]),        
